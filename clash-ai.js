...
function main(config) {
  ...
  config["proxy-groups"] = [
    ...
    },
    {
      ...
      "name": "故障转移",
      "type": "fallback",
      "proxies": ["日本-故障转移", "美国-故障转移", "台湾-故障转移", "香港-故障转移", "新加坡-故障转移", "韩国-故障转移"],
    ...
    },
    {
      ...
      "name": "谷歌服务",
      "type": "select",
      "proxies": ["美国", "美国-延迟选优", "美国-故障转移", "日本", "日本-延迟选优", "日本-故障转移", "新加坡", "新加坡-延迟选优", "新加坡-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "台湾", "台湾-延迟选优", "台湾-故障转移", "全局直连"],
    ...
    },
    {
      ...
      "name": "YouTube",
      "type": "select",
      "proxies": ["美国", "美国-延迟选优", "美国-故障转移", "日本", "日本-延迟选优", "日本-故障转移", "新加坡", "新加坡-延迟选优", "新加坡-故障转移", "台湾", "台湾-延迟选优", "台湾-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "全局直连"],
    ...
    },
    {
      ...
      "name": "电报消息",
      "type": "select",
      "proxies": ["日本", "日本-延迟选优", "日本-故障转移", "美国", "美国-延迟选优", "美国-故障转移", "新加坡", "新加坡-延迟选优", "新加坡-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "台湾", "台湾-延迟选优", "台湾-故障转移", "全局直连"],
    ...
    },
    {
      ...
      "name": "AI",
      "type": "select",
      "proxies": ["美国", "美国-延迟选优", "美国-故障转移", "日本", "日本-延迟选优", "日本-故障转移", "新加坡", "新加坡-延迟选优", "新加坡-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "台湾", "台湾-延迟选优", "台湾-故障转移"],
    ...
    },
    {
      ...
      "name": "TikTok",
      "type": "select",
      "proxies": ["美国", "美国-延迟选优", "美国-故障转移", "日本", "日本-延迟选优", "日本-故障转移", "新加坡", "新加坡-延迟选优", "新加坡-故障转移", "台湾", "台湾-延迟选优", "台湾-故障转移", "香港", "香港-延迟选优", "香港-故障转移"],
    ...
    },
    {
      ...
      "name": "微软服务",
      "type": "select",
      "proxies": ["全局直连", "美国", "美国-延迟选优", "美国-故障转移", "日本", "日本-延迟选优", "日本-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "台湾", "台湾-延迟选优", "台湾-故障转移"],
    ...
    },
    {
      ...
      "name": "动画疯",
      "type": "select",
      "proxies": ["台湾", "台湾-延迟选优", "台湾-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "日本", "日本-延迟选优", "日本-故障转移", "新加坡", "新加坡-延迟选优", "新加坡-故障转移", "美国", "美国-延迟选优", "美国-故障转移"],
      "icon": "https://images.icon-icons.com/872/PNG/96/anime-boy-with-headphones_icon-icons.com_68063.png"
    },
    {
      ...groupBaseOption,
      "name": "哔哩哔哩港澳台",
      "type": "select",
      "proxies": ["台湾", "台湾-延迟选优", "台湾-故障转移", "香港", "香港-延迟选优", "香港-故障转移", "全局直连"],
