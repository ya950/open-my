...
<body>
    ...
    <div style="text-align: center; margin-top: 20px;">
      ...
      <button class="github-btn" onclick="window.open('https://github.com/yourusername/clash-config-converter')">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" style="vertical-align: middle; margin-right: 5px;">
          <path d="M8 0C3.58 0 0 3. 0 1.24 1.46l-4. 4.17c-.96.96-2.12 2.12-2.12 2.12 0 2.83.22 3.5.96.42.04 1.64.04 1. 64 0 2.83-.22 3.5-.96 1.46-4.17 4.17zM8 2.83c0-1.1.9-2 2-2 2-.3 0-.5.5-1.1.9-1.6 1.4-.3.3-.6.6-.7 1.2-.1.8.1.8.1.8 0 3.42-1.64 1.64-1.64 0-2.83-.22-3.5-.96-.42-.04-1.64-.04-1.64 0-2.83.22-3.5.96 1.46-4.17 4.17zM12.16 8.16c-1.1.9-2 2-2 2-.3 0-.5.5-1.1.9-1.6 1.4-.3.3-.6.6-.7 1.2-.1.8.1.8.1.8 0 3.42-1.64 1.64-1.64 0-2.83-.22-3.5-.96-.42-.04-1.64-.04-1.64 0-2.83.22-3.5.96 1.46-4.17 4.17zM12.16 8.16c-1.1.9-2 2-2 2-.3 0-.5.5-1.1.9-1.6 1.4-.3.3-.6.6-.7 1.2-.1.8.1.8.1.8 0 3.42-1. 1.64-1.64 0-2.83-.22-3.5-.96-.42-.04-1.64-.04-1.64 0-2.83.22-3.5.96 1.46-4.17 4.17z"/>
        </svg>
        GitHub 仓库
      </button>
    </div>
  ...
  <script>
    ...
    function downloadConfig() {
      ...
      const blob = new Blob([resultText]， { 输入: 'text/yaml' });
